...
The **NiN 2.0** QGIS template is uploaded to NINA's QField Cloud account. For general instructions on QGIS, QField and QField Cloud follow the guide: [QGIS and QField introduciton](/qgis/qfield-intro.qmd).
