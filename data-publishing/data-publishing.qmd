...
2. Django admin - Add background layer to the map. 
    ...
    - add source OSM!
    - Django admin -> Maps -> Layers -> Add layer
    ...
    | Name | OSM |
    | slug | osm |
    | Map | *Title of the map* |
    | Style | {"type": "raster"} |
    | Is basemap | checked |

3. Naturregnskaps API - Upload map layers and metadata 

    a. Check the import schema (*provided by the data manager*)

    b. Prepare the raster data

    c. Prepare the vector data

    d. Prepare the style file 
