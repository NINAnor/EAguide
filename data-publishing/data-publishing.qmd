...
NINA's catalogue consists of a [Map Catalogue](https://maps.nina.no/) for viewing and dowloading maps and a [Metadata Catalogue](https://pycsw.nina.no/geoapi/) for accessing metadata. For the Local Ecosystem Accounts dataset (*Finskala Naturregnskap*) the maps are uploaded into the **Map Catalogue**, in the future these maps can also be uploaded in the *Metadata Catalogue*. 
 ...
 **GitHub repositories**:
 - [nina-catalogue](https://github.com/NINAnor/nina-catalogue)
 - 
